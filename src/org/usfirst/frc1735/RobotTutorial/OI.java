...
public class OI {
    ...
    public JoystickButton drivetrainToggler;
    ...
    public OI() {
        ...
        arcadeMode = new JoystickButton(joyRight, 2);
        arcadeMode.whenPressed(new EnterArcadeMode());
        tankMode = new JoystickButton(joyRight, 1);
        tankMode.whenPressed(new EnterTankMode());
        drivetrainToggler = new JoystickButton(joyRight, 3);
        drivetrainToggler.whenPressed(new ToggleDrivetrain());
        ...
        SmartDashboard.putData("EnableLight", new EnableLight());
